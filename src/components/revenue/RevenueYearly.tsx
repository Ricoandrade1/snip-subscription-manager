...
interface RevenueYearlyProps {
  payments: Payment[];
}

export function RevenueYearly({ payments }: RevenueYearlyProps) {
  const generatePDF = () => {
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-semibold text-barber-gold">Receita Anual</h2>
